        ...
        <div className="p-6 flex flex-col items-center">
          ...
          <div className="mt-6 w-full grid grid-cols-3 gap-4">
            <div className="flex flex-col items-center p-3 rounded-xl bg-card">
              <p className="text-2xl font-bold text-primary">{user.stats.supported}</p>
              <p className="text-xs text-muted-foreground mt-1">후원한 작품</p>
            </div>
            <div className="flex flex-col items-center p-3 rounded-xl bg-card">
              <p className="text-2xl font-bold text-secondary">{(user.stats.totalDrops / 1000).toFixed(0)}K</p>
              <p className="text-xs text-muted-foreground mt-1">누적 후원</p>
            </div>
            <div className="flex flex-col items-center p-3 rounded-xl bg-card">
              <p className="text-2xl font-bold text-foreground">{user.stats.saved}</p>
              <p className="text-xs text-muted-foreground mt-1">저장한 작품</p>
            </div>
          </div>
        </div>
